...
export default function Banner() {
  return (
    ...
    justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#6B1E23] to-[#522C5D]
    max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden my-20'>
        ...
        text-center md:text-left mb-6 md:mb-0 md:pr-6 lg:pr-10'>
            ...
            <button className='px-6 py-2 bg-fuchsia-700 hover:bg-fuchsia-800 transition-all
